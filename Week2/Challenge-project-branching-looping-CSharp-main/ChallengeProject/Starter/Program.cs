...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    ...
                    if (ourAnimals[i, 3] == "Physical description: " || ourAnimals[i, 3] == "Physical description: tbd")
                    {
                        Console.WriteLine($"Enter a physical description for {ourAnimals[i, 0]} (size, color, breed, gender, weight, etc.):");
                        string physicalDescription = Console.ReadLine();
                        
                        while (string.IsNullOrWhiteSpace(physicalDescription))
                        {
                            Console.WriteLine("Physical description cannot be empty. Please try again:");
                            physicalDescription = Console.ReadLine();
                        }
                        
                        ourAnimals[i, 3] = $"Physical description: {physicalDescription}";
                    }
                }
            }
            
            Console.WriteLine("Age and physical description information has been updated for all pets.");
            break;
        ...
        case "4":
            ...
            // Console.WriteLine("Press the Enter key to continue.");
            // readResult = Console.ReadLine();
            // Loop through the ourAnimals array
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    ...
                    // Check if personality description is missing
                    if (ourAnimals[i, 4] == "Personality: " || ourAnimals[i, 4] == "Personality: tbd")
                    {
                        Console.WriteLine($"Enter a personality description for {ourAnimals[i, 0]} (likes, dislikes, tricks, energy level, etc.):");
                        string personalityDescription = Console.ReadLine();
                        
                        while (string.IsNullOrWhiteSpace(personalityDescription))
                        {
                            Console.WriteLine("Personality description cannot be empty. Please try again:");
                            personalityDescription = Console.ReadLine();
                        }
                        
                        ourAnimals[i, 4] = $"Personality: {personalityDescription}";
                    }
                }
            }
            
            Console.WriteLine("Nickname and personality description information has been updated for all pets.");
        ...
        case "7":
            ...
            Console.WriteLine("UNDER CONSTRUCTION - please check back next month to see progress.");
            Console.WriteLine("Press the Enter key to continue.");
            readResult = Console.ReadLine(); break;
